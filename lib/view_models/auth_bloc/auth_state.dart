...
class AuthState {
  ...
  @override
  String toString() {
    return 'AuthState(loginStatus: $loginStatus, registerStatus: $registerStatus, forgotPasswordStatus: $forgotPasswordStatus, logoutStatus: $logoutStatus, userDetails: $userDetails)';
  }
}
